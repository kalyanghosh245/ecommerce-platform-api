...
exports.ProductResponseDto = exports.ProductSearchDto = exports.UpdateProductDto = exports.CreateProductDto = void 0;
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: ['draft', 'active', 'archived'] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(['draft', 'active', 'archived']),
    __metadata("design:type", String)
...
class ProductSearchDto extends pagination_dto_1.PaginationDto {
}
